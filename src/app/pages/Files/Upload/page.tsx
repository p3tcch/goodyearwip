...
export default function FileUpload() {
  ...
  return (
    <div className="flex jcenter acenter dircol">
      ...
      <h1 className='filesupload-header'> File Upload </h1>

   
        <form action={onSubmit}  className='filesupload-container flex jcenter dircol'>
          <input
            id="file"
            name="file"
            type="file"
          ...
          &nbsp;
          <div className='flex jend'><button className="filesupload-btn" value="submit"> upload </button></div>
        </form>
